...
namespace duke3d.game
{
    public static class SoundSystem
    {
        ...
        */
        ...
        {
            Sounddef.LASERTRIP_EXPLODE,
            Sounddef.DUKE_GRUNT,
            Sounddef.DUKE_LAND_HURT,
            Sounddef.CHAINGUN_FIRE,
            Sounddef.SQUISHED,
            Sounddef.KICK_HIT,
            Sounddef.PISTOL_RICOCHET,
            Sounddef.PISTOL_BODYHIT,
            Sounddef.PISTOL_FIRE,
            Sounddef.SHOTGUN_FIRE,
            Sounddef.BOS1_WALK,
            Sounddef.RPG_EXPLODE,
            Sounddef.PIPEBOMB_BOUNCE,
            Sounddef.PIPEBOMB_EXPLODE,
            Sounddef.NITEVISION_ONOFF,
            Sounddef.RPG_SHOOT,
            Sounddef.SELECT_WEAPON
        };
        ...
        public static void playmusic(byte[] fn)
        {
        ...
        public static bool loadsound(ushort num)
        {
            ...
            if(num >= Duke3d.NUM_SOUNDS) return false;

            Duke3d.Sound[num].sndeffect = soundManager.LoadSound(Duke3d.sounds[num]);
        ...
        //    if(num != 358) return 0;
            ...
            return (voice);
#else
            Duke3d.Sound[num].sndeffect.PlaySound();
            return 1;
#endif
        }
        ...
        {
            if(num >= Duke3d.NUM_SOUNDS) return -1;
            return xyzsound((short)num,i,Duke3d.SX(i),Duke3d.SY(i),Duke3d.SZ(i));
        }
